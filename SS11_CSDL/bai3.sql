...
-- cau 2
DELIMITER &&
create procedure GetCustomerByPhone(in phone_number varchar(11))
begin
...
create procedure GetTotalBalance(in customer_id int , out TotalBalance decimal)
begin 
	select sum(a.balance) into TotalBalance
    from accounts a
...
call GetTotalBalance(2,@TotalBalance);
select @TotalBalance;
-- 4
DELIMITER &&
